    ...
    <div className="flex max-w-[90dvw] m-auto pt-5 items-center justify-center gap-2 max-md:flex-wrap">
      <Card radius="lg" className="border-none max-md:w-[120px]">
        <Image
          ...
          width={200}
        />
        <CardFooter className="justify-center overflow-hidden py-1 absolute before:rounded-xl rounded-large w-[calc(100%_-_20px)] h-[calc(100%_-_20px)] ml-[10px] mt-[10px] z-10 flex flex-col bg-gray-500/75">
